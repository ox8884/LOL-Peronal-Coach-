...
class CoachAppAPI(Protocol):
    ...
    def _ai_coach_review(self, m: Any, rev: Any, key: str, on_delta: Any = None) -> Any: ...
    def _ai_coach_lane(self, *args: Any, **kwargs: Any) -> Any: ...
    def _ai_coach_comp(self, *args: Any, **kwargs: Any) -> Any: ...
    def _ai_coach_aram(self, *args: Any, **kwargs: Any) -> Any: ...
